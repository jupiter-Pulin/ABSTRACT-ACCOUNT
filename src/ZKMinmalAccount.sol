...
contract ZKMinimalAccount is IAccount, Ownable {
    ...
    function prepareForPaymaster(
        ...
        // This function is called when a paymaster is used
        // For a minimal account, we don't need special paymaster preparation
        // But we must include the modifier to ensure only bootloader can call it
    }
